    ...
    <div>
        <form action="../server/record-list-server.php" method="post">
            <div>
                ...
                $rowInDb = mysqli_num_rows($result);
                ...
                if ($result) {
                    if ($rowInDb > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $resultBand = mysqli_fetch_all($query);
        ...
        <div>
            <div>
                <button onclick="location.href ='add-record-list-client.php'" style="background : lightgreen;"> add record
                </button>
            </div>
        </div>
    </div>
